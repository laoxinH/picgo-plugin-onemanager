...
const upload = async (ctx,url,img,imgUrl) => {
    ...
    const customHeader = {"content-length":totalsize,"Content-Range":'bytes ' + asize + '-' + bsize +'/'+ totalsize/*,"contentType":"base64Encoded"*/}
    ...
    let md5 = crypto.createHash("md5");
        ...
        return new Promise(resolve => {
            $.post(getUrlOpts,(err,resp,data) =>{
                ...
                if (resp.status == 200){
                    data.imgName = getUpload.upbigfilename;
                    data.imgUrl = url + getUpload.upbigfilename;
                    resolve(data);
                }
            })
        })
